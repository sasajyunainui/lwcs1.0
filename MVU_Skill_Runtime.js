...
function getBaseStats(lv) {
  ...
  let 精神力上限 = 等级值;
  if (等级值 <= 20) 精神力上限 = 等级值;
  else if (等级值 <= 30) 精神力上限 = 20 + ((47 - 20) / 10) * (等级值 - 20);
  else if (等级值 <= 50) 精神力上限 = 47 + Math.pow(等级值 - 30, 2) * ((432 - 47) / 400);
  else if (等级值 <= 70) 精神力上限 = 432 + Math.pow(等级值 - 50, 2) * ((3000 - 432) / 400);
...
var 初始化修为年龄描点表 = Object.freeze({
  ...
  天才: Object.freeze([[6, 10], [9, 20], [10, 21], [15, 35], [20, 48], [30, 69], [40, 80], [50, 85], [100, 90], [150, 90]]),
  顶级天才: Object.freeze([[6, 10], [9, 20], [10, 21], [15, 37], [20, 53], [30, 74], [40, 89], [50, 94], [100, 96], [150, 96]]),
  绝世妖孽: Object.freeze([[6, 10], [9, 20], [10, 21], [15, 37], [20, 53], [30, 98], [40, 99.5], [150, 99.5]]),
});

...
const utf8ScanTargets = [
  ...
  'tools/audit_battle_v73_performance.mjs',
  'tools/audit_battle_summon_trace.mjs',
  'tools/audit_battle_report_samples.mjs',
  'tools/audit_battle_report_render_html.mjs',
...
const commandDefinitions = [
  ...
  { name: 'auditBattleR63ShadowDecision', command: [process.execPath, ['lwcs/tools/audit_battle_r63_shadow_decision.mjs']], parseJson: true, timeoutMs: 30000, groups: ['quick', 'full', 'case'] },
  ...
  { name: 'auditBattleR63ShadowSettlement', command: [process.execPath, ['lwcs/tools/audit_battle_r63_shadow_settlement.mjs']], parseJson: true, timeoutMs: 60000, groups: ['quick', 'full', 'case'] },
  ...
  { name: 'syntaxMvuLogicBridge', command: [process.execPath, ['--check', 'lwcs/mvu_logic_bridge.js']], timeoutMs: 30000, groups: ['quick', 'full', 'case'] },
  {
    ...
    command: [process.execPath, ['tools/audit_battle_v73_formal_cases.mjs', ...(requestedCase ? ['--case', requestedCase] : [])]],
    parseJson: true,
    timeoutMs: 60000,
    groups: ['quick', 'full', 'case'],
  },
  { name: 'auditBattleReportRenderHtml', command: [process.execPath, ['tools/audit_battle_report_render_html.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full'] },
  { name: 'auditBattleAntiAgile', command: [process.execPath, ['tools/audit_battle_anti_agile.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full'] },
  { name: 'auditBattleSecondSkillPath', command: [process.execPath, ['tools/audit_battle_second_skill_path.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full'] },
  { name: 'auditBattleLedgerStrictness', command: [process.execPath, ['tools/audit_battle_ledger_strictness.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full'] },
  { name: 'auditBattleSummonTrace', command: [process.execPath, ['tools/audit_battle_summon_trace.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full'] },
  ...
  { name: 'auditBattleReportSamples', command: [process.execPath, ['tools/audit_battle_report_samples.mjs']], parseJson: true, timeoutMs: 120000, groups: ['full'] },
  ...
  { name: 'auditBattleV73Performance', command: [process.execPath, ['tools/audit_battle_v73_performance.mjs']], parseJson: true, timeoutMs: 300000, groups: ['full'] },
  {
    name: 'runBattleClosureAudit',
    command: [process.execPath, ['tools/run_battle_closure_audit.mjs', ...(acceptSamples ? ['--skip-sample-audit'] : [])]],
    timeoutMs: 300000,
    groups: ['full'],
  },
];

const commands = commandDefinitions.filter(item =>
  item.groups.includes(mode) &&
  !(acceptSamples && item.name === 'auditBattleReportSamples')
);

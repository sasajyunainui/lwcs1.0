...
const utf8ScanTargets = [
  ...
  'lwcs/tools/audit_battle_r83_phase8.mjs',
...
const commandDefinitions = [
  ...
  {
    name: 'auditBattleR83Phase8',
    command: [process.execPath, ['lwcs/tools/audit_battle_r83_phase8.mjs']],
    parseJson: true,
    timeoutMs: 180000,
    groups: ['quick', 'full', 'case'],
    minPhase: 8,
  ...
  {
    name: 'auditBattleR83Phase9',
    command: [process.execPath, ['lwcs/tools/audit_battle_r83_phase9.mjs']],
    parseJson: true,
    timeoutMs: 900000,
    groups: ['quick', 'full'],
    minPhase: 9,

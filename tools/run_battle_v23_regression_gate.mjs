...
const commandDefinitions = [
  ...
  { name: 'auditBattleR63RuntimePrepareSustain', command: [process.execPath, ['lwcs/tools/audit_battle_r63_runtime_prepare_sustain.mjs']], parseJson: true, timeoutMs: 60000, groups: ['quick', 'full', 'case'] },
  ...
  { name: 'auditBattleR74ReportDto', command: [process.execPath, ['lwcs/tools/audit_battle_r74_report_dto.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full', 'case'], minPhase: 3 },
  { name: 'auditBattleR74ValueKernel', command: [process.execPath, ['lwcs/tools/audit_battle_r74_value_kernel.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full', 'case'], minPhase: 4 },
  { name: 'auditBattleR74KernelAb', command: [process.execPath, ['lwcs/tools/audit_battle_r74_kernel_ab.mjs']], parseJson: true, timeoutMs: 120000, groups: ['quick', 'full', 'case'], minPhase: 5 },
  { name: 'auditBattleR74Phase6Matrix', command: [process.execPath, ['lwcs/tools/audit_battle_r74_phase6_matrix.mjs']], parseJson: true, timeoutMs: 180000, groups: ['quick', 'full', 'case'], minPhase: 6 },
  { name: 'auditBattleR74Phase7Report', command: [process.execPath, ['lwcs/tools/audit_battle_r74_phase7_report.mjs']], parseJson: true, timeoutMs: 300000, groups: ['quick', 'full', 'case'], minPhase: 7 },
